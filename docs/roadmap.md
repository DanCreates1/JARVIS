...
11. Explicitly opt-in proactive and advanced multimodal assistance. Phases 11A–11D trigger policy,
    foreground inbox runner, scoped PWA ownership, and long-duration closeout are complete.
